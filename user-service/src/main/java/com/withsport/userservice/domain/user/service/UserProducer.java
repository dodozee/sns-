...
import com.withsport.userservice.domain.user.dto.producer.KafkaProduceInitUserDto;
import com.withsport.userservice.domain.user.dto.producer.KafkaProduceUpdateUserProfileDto;
...
public class UserProducer {
    ...
    public void createUser(User user) throws Exception{
        ...
        kafkaTemplate.send("initUserForRecord", json);
    ...
    public void updateUser(User user) throws Exception{
        ...
        String json = objectMapper.writeValueAsString(kafkaSendUserDto);
        kafkaTemplate.send("updatedUserForRecord", json);
        kafkaTemplate.send("updatedUserForPoint", json);
        kafkaTemplate.send("updatedUserForMatching", json);
        kafkaTemplate.send("updatedUserForTeam", json);
